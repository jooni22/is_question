test_cases = [
    ...
    ("I wonder if this is a question.", ["I wonder if this is a question."]),
    ...
    ("I'd like to know more about this topic.", ["I'd like to know more about this topic."]),
    ...
    ("You call that a question?", ["You call that a question?"]),
    ...
    ("Have you heard about the new environmental initiative in our city? They're planting trees all over. It's supposed to help reduce carbon emissions. What are your thoughts on this approach?", ["What are your thoughts on this approach?", "Have you heard about the new environmental initiative in our city?"]),
    ...
    ("I'm considering adopting a pet. It's a big responsibility. Do you have any experience with pets? What kind would you recommend for a first-time owner?", ["What kind would you recommend for a first-time owner?", "Do you have any experience with pets?"]),
    ...
    ("Yeah. Of course. And you some I think so. Just to make you a bit louder. Test. Test. Test. Okay. So may maybe I will try to increase the volume. Okay? No. It's fine, actually. It's fine, actually. I think it does a different Yes. So pleasure to see you, and welcome. I'm happy we managed to still do this interview even though some force majeure happened, as I understand. For you. But, like, hopefully, your son's okay. So, my name is Luma. I am from HR at Smart Security, and we have Christopher's with us. He is IT guy from the team for which we look people. So, basically, we both joined today just to tell you more about us, about the position which we have, open. And, of course, we will have questions for you, about you, and, you know, your your vision for your future. So we have 1 hour booked and, and, we will be making notes, so don't mind us typing, please. Just we want to remember facts about you. And, feel free just to ask whenever you have questions because it's not only us choosing, but you as well. You need to figure out if you want to do things we do. So, Martin, I have a little question before we start. Because well, basically, I understand that you applied to this position. So, you probably are looking for the opportunities And my question for you is why? What's happening in your life that you decided to, you know, to look for new opportunities? What's your motivation?", ["What's happening in your life that you decided to, you know, to look for new opportunities?", "What's your motivation?", "Okay?", "So, you probably are looking for the opportunities And my question for you is why?", "So, basically, we both joined today just to tell you more about us, about the position which we have, open."]),
    ("Tell me if it is possible to ask a question without a question mark!", ["Tell me if it is possible to ask a question without a question mark!"]),
    ("I wonder if it is possible to ask a question without using a question mark.", ["I wonder if it is possible to ask a question without using a question mark."]),
    ("Tell me what you think about climate change", ["Tell me what you think about climate change"]),
    ("I wonder how long it takes to learn a new language", ["I wonder how long it takes to learn a new language"]),
    ("Let me know where you'd like to meet", ["Let me know where you'd like to meet"]),
    ("Explain why the sky appears blue", ["Explain why the sky appears blue"]),
    ("Describe your ideal vacation destination", ["Describe your ideal vacation destination"]),
    ("I'd like to know your opinion on remote work", ["I'd like to know your opinion on remote work"]),
    ("Share your thoughts on the future of artificial intelligence", ["Share your thoughts on the future of artificial intelligence"]),
    ("Tell me about your favorite childhood memory", ["Tell me about your favorite childhood memory"]),
    ("I'm curious about your approach to problem-solving", ["I'm curious about your approach to problem-solving"]),
    ("Elaborate on the importance of biodiversity", ["Elaborate on the importance of biodiversity"]),
    ("I was wondering if you could explain the theory of relativity.", ["I was wondering if you could explain the theory of relativity."]),
    ("Would you mind sharing your thoughts on the current economic situation?", ["Would you mind sharing your thoughts on the current economic situation?"]),
    ("Do you happen to know when the next train arrives?", ["Do you happen to know when the next train arrives?"]),
    ("I'm not sure if you're aware of any good restaurants in the area.", ["I'm not sure if you're aware of any good restaurants in the area."]),
    ("Could you possibly tell me how to get to the nearest post office?", ["Could you possibly tell me how to get to the nearest post office?"]),
    ("I was hoping you might be able to clarify the company's new policy.", ["I was hoping you might be able to clarify the company's new policy."]),
    ("I'm curious as to whether you've ever visited South America.", ["I'm curious as to whether you've ever visited South America."]),
    ("Have you any idea why the project deadline was extended?", ["Have you any idea why the project deadline was extended?"]),
    ("Might I inquire about your experience with coding languages?", ["Might I inquire about your experience with coding languages?"]),
    ("I'd be interested to know your perspective on renewable energy sources.", ["I'd be interested to know your perspective on renewable energy sources."])
]